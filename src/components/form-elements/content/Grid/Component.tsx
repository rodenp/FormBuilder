...
export const Component: React.FC<{ element: FormElement }> = ({ element }) => {
    // Replicating logic from componentHtml.tsx getContainerHtml for backward compatibility
    // "Grid" in this system is actually just another Flex container
    ...
    return (
        ...
        >
            {element.children && element.children.length > 0 ? (
                ...
                <div className="text-slate-400 text-sm text-center py-2">Empty grid</div>
            )}
        </div>
    );
};
