...
const CustomBlockItem: React.FC<{ block: FormElement; onRemove: () => void; onEditCategory: () => void; canvasElements: FormElement[] }> = ({ block, onRemove, onEditCategory, canvasElements }) => {
    ...
    return (
        <div
            ref={setNodeRef}
            style={style}
            className="group relative bg-white border border-slate-200 rounded-lg overflow-hidden cursor-grab active:cursor-grabbing hover:border-brand-300 hover:shadow-sm transition-all"
            {...listeners}
            {...attributes}
        >
            ...
            <div className="absolute top-1 right-1 z-10 opacity-0 group-hover:opacity-100 transition-opacity flex gap-1">
                <button
                    ...
                    className="p-1 bg-white rounded shadow-sm text-slate-400 hover:text-blue-500 transition-colors"
                    title="Edit category"
                >
                    <Edit2 size={12} />
                </button>
                <button
                    ...
                    className="p-1 bg-white rounded shadow-sm text-slate-400 hover:text-red-500 transition-colors"
                    title="Remove block"
                >
                    <Trash2 size={12} />
                </button>
                        ...
                        <div className="p-4 h-full bg-white">
                            {customBlocks.length === 0 ? (
                                <div className="text-center py-8">
                                    ...
                                    <p className="text-sm text-gray-600 mb-2">No custom blocks yet</p>
                                            ...
                                            return (
                                                <div key={category} className="space-y-2">
                                                    <button
                                                        ...
                                                        className="flex items-center justify-between w-full px-2 py-1 hover:bg-gray-50 rounded transition-colors group"
                                                    >
                                                        <h4 className="text-xs font-semibold text-gray-700 uppercase tracking-wide text-left">
                                                            {category}
                                                        </h4>
