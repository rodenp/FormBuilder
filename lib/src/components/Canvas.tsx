...
export const Canvas: React.FC = () => {
    ...
    return (
        <div
            className="flex-1 bg-slate-50/50 p-8 overflow-y-auto relative"
        ...
        >
            <div className="max-w-4xl mx-auto pb-20">
                <div
                    ref={setNodeRef}
                    className={clsx(
                        "min-h-[800px] bg-white rounded-2xl shadow-card p-10 transition-all duration-300",
                        elements.length === 0 && "flex flex-col items-center justify-center border-2 border-dashed border-slate-200"
                    )}
                >
                    {elements.length === 0 ? (
                        <div className="text-center max-w-sm">
                            ...
                            <h3 className="text-xl font-bold text-slate-800 mb-2">Start Building</h3>
